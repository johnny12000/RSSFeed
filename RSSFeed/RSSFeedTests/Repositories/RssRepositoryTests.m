...
- (void)testUpdateSource{
    ...
    Source* src = [[Source alloc]init]; //]WithName:@"test1" url:@"url" index:2 andImage:nil andIsUsed:TRUE];
...
- (void) testDeleteSource {
    Source *src = [[Source alloc] init]; //initWithUid:@"F46C37B4-EC15-478A-9560-7FA757B49C7A" name:@"" url:@"" index:1 andImage:nil andIsUsed:TRUE];
...
- (void) testAddSource {
    ...
    Source* src = [[Source alloc] init]; //initWithName:@"testAdd" url:@"urlAdd" index:4 andImage:nil andIsUsed:TRUE];
